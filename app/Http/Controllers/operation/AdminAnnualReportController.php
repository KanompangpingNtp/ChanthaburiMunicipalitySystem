...
class AdminAnnualReportController extends Controller
{
    public function AnnualReportAdmin()
    {
        ...
        return view('admin.post.operation.annual_report.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function AnnualReportCreate(Request $request)
    {
        $request->validate([
    ...
    public function AnnualReportUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function AnnualReportDelete($id)
    {
    ...
    public function AnnualReportShowDetails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.operation.annual_report.show_details', compact('PerfSingleTopic',));
    }

    public function AnnualReportCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function AnnualReportDetailsDelete($fileId)
    {
