...
class AdminBudgetReportController extends Controller
{
    public function BudgetReportAdmin()
    {
        ...
        return view('admin.post.operation.budget_report.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function BudgetReportCreate(Request $request)
    {
        $request->validate([
    ...
    public function BudgetReportUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function BudgetReportDelete($id)
    {
    ...
    public function BudgetReportShowDetails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.operation.budget_report.show_details', compact('PerfSingleTopic',));
    }

    public function BudgetReportCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function BudgetReportDetailsDelete($fileId)
    {
