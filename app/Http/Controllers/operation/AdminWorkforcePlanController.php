...
class AdminWorkforcePlanController extends Controller
{
    public function WorkforcePlanAdmin()
    {
        ...
        return view('admin.post.operation.workforce_plan.page', compact('PerfSingleTopic', 'perfResultsType'));
    }

    public function WorkforcePlanCreate(Request $request)
    {
        $request->validate([
    ...
    public function WorkforcePlanUpdate(Request $request, $id)
    {
        $request->validate([
            'detail_name' => 'required|string',
        ]);
    ...
    public function WorkforcePlanDelete($id)
    {
    ...
    public function WorkforcePlanShowDetails($id)
    {
        $PerfSingleTopic = PerfSingleTopic::with('files')->findOrFail($id);

        return view('admin.post.operation.workforce_plan.show_details', compact('PerfSingleTopic',));
    }

    public function WorkforcePlanCreateFiles(Request $request, $DetailsId)
    {
        $request->validate([
    ...
    public function WorkforcePlanDetailsDelete($fileId)
    {
