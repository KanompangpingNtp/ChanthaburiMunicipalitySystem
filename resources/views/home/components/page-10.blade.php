...
<main class="bg-page10 d-flex flex-column justify-content-start align-items-center gap-5">
    <div class="container d-flex mt-5">
        <div class="title-section-10 lh-1 text-white" style="font-size: 72px;">
            ...
            <div class="fs-2">เทศบาลเมืองจันทบุรี</div>
        </div>
    </div>
    ...
    <div class="bg-footer d-flex">
        <div class="container d-flex justify-content-between">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center text-light  lh-1">
                <div style="font-size:82px;" class="fw-bold">
                    1132
                </div>
                <div class="fs-4">
                    สายด่วนเมืองจันท์
